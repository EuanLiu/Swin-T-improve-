...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', type=str, default="snapshot/SINet_V2/Net_epoch_137.pth", help='train from checkpoints')
    ...
    if opt.weights != "":
        ...
        for k in list(weights_dict.keys()):
            if "head" in k:
                del weights_dict[k]
        print(model.swin_transfomer.load_state_dict(weights_dict, strict=False))
